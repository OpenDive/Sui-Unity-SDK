...
### Test Suite
The SDK's test suite can be found in the following directory: `Test/`.   
...
Sui-Unity-SDK is released under the Apache 2.0 license. [See LICENSE](https://github.com/aptos-labs/Aptos-Unity-SDK/blob/main/LICENSE) for details.